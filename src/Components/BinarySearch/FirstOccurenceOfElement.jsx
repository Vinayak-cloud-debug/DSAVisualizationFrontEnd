...
const checkPaused = async () => {
  ...
  const visualizeBinarySearch = async () => {
    ...
    setIsSearching(false);
        ...
        setFound(true)
        toast.success(`First Occurrence at index ${ans}`, {
            icon: '🎯',
            style: {
              borderRadius: '10px',
              background: '#333',
      ...
      <div className="relative z-10 w-full max-w-6xl mx-auto flex flex-col items-center">
        ...
        <div className="relative mb-8">
          ...
          <p className="text-gray-400 text-center mt-3 max-w-xl">
            Visualize how binary search efficiently finds the smallest element that is greater than equal to searchValue .. this is lower Bound
          </p>
        </div>

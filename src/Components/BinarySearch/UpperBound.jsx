...
const UpperBound = () => {
  ...
  const [ubound,setUBound] = useState(-1)
...
const checkPaused = async () => {
  ...
  const visualizeBinarySearch = async () => {
    ...
    setIsSearching(false);
        ...
        setFound(true)
        toast.success(`Upper Bound at index ${ans}`, {
            icon: '🎯',
            style: {
              borderRadius: '10px',
              background: '#333',
      ...
      <div className="relative z-10 w-full max-w-6xl mx-auto flex flex-col items-center">
        ...
        <div className="relative mb-8">
          ...
          <p className="text-gray-400 text-center mt-3 max-w-xl">
            Visualize how binary search efficiently finds the greatest element that is smaller than searchValue
          </p>
        </div>

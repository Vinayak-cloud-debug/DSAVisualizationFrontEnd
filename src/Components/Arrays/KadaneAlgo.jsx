...
const checkPaused = async () => {
  ...
  const handlestartSlidingWindow = async () => {
    ...
    let lmaxi = 0,rmaxi = 0,sum = 0,Maxi = 0;
  ...
  const bubbleSortCode = `function KadaneAlgo(nums):
  ...
  Add the sum until the sum > 0 and update max sum everytime , once the 
  sum is < 0 then reset sum = 0 and then continue the process
  until the loop ends
    ...
    <div className="relative z-10 flex flex-col bg-gray-950 min-h-screen w-full px-4 py-8 overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-6xl mx-auto flex flex-col items-center">
        ...
        <div className="relative mb-8">
          <h1 className="text-3xl text-center sm:text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-teal-400 via-emerald-500 to-green-600">
            Kadane Algo
          </h1>
          ...
          <p className="text-gray-400 text-center mt-3  lg:max-w-2xl">
            Visualize how Kadane Algo (adding sum and updating maxi and then when sum is less than zero reset the sum = 0 and then continue the process) adjacent elements
          </p>
        </div>
        ...
        <div className="backdrop-blur-sm bg-gray-900/50 border border-gray-800 rounded-xl p-6 w-full max-w-3xl mb-8">
          ...
          <div className="flex flex-wrap gap-3 mt-6">
            ...
            >
              <PlayCircle size={18} />
              {isSorting ? "Finding Max Sum..." : "Start Kadane Algo"}
            </button>
        ...
        <div className="w-full max-w-3xl mb-8 space-y-4">
          ...
          {showInfo && (
            <div className="backdrop-blur-sm bg-gray-900/70 border border-gray-800 rounded-xl p-4 w-full overflow-x-auto">
              <h3 className="text-lg font-medium text-emerald-400 mb-3">About Kadane Algo</h3>
        ...
        {arr.length > 0 && (
          ...
          >
              ...
              {arr.map((val, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    {isCurr && (
                      <div className="absolute -top-14 flex flex-col items-center">
                        <span className="text-red-500 text-sm font-medium mb-1">curr</span>
                        <div className="h-8 w-px bg-gradient-to-b from-orange-500  to-transparent"></div>
            ...
            <div className="flex flex-col gap-3 justify-center items-center mt-4">
              ...
              <span className={`ml-2 text-2xl font-bold ${currSum !== 0 ? "text-emerald-500" : "text-gray-400"}`}>
                  Current Sum: {currSum} 
                </span>

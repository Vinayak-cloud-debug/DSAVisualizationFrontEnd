...
//           <h1 className="text-3xl text-center lg:ml-12 sm:text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-purple-400 via-pink-500 to-indigo-400">
//             Quick Sort Algorithm
//           </h1>
//           <div className="mt-2 h-1 w-full bg-gradient-to-r from-transparent via-pink-500 to-transparent rounded-full"></div>
...
const QuickSort = () => {
  ...
  const getPointerStyle = (type) => {
    const baseStyle = "absolute transform translate-x-0 flex flex-col items-center justify-center";
    ...
    <div className="flex flex-col min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-black text-gray-100">
      ...
      <header className="w-full py-6 bg-black/40 backdrop-blur-sm">
        <div className="relative mb-6 w-[90%] mx-auto">
          ...
          <div className="mt-2 h-1.5 w-full bg-gradient-to-r from-transparent via-purple-500 to-transparent rounded-full"></div>
      ...
      <main className="flex-grow container mx-auto px-4 py-6">
        {/* Controls Section */}
        <div className="mb-8 bg-gray-800/70 p-5 rounded-xl shadow-lg backdrop-blur-sm border border-gray-700/50">
          <div className="flex flex-col md:flex-row gap-4">
            <div className="flex-1">
              <input
                type="text"
                className="w-full p-3 rounded-lg bg-gray-700/80 border border-purple-500/30 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-purple-500 transition-all shadow-md"
                placeholder="Enter numbers separated by spaces"
                value={inputValue}
                onChange={handleInput}
                disabled={isSorting}
              ...
              <div key={index} className="flex flex-col items-center justify-center relative">
                ...
                <div className="h-12 w-full relative">
                  ...
                  {index === pivotIndex && (
                    <div className={getPointerStyle('pivot')}>
                      <div className="flex flex-col items-center">
                        ...
                        <ArrowDown className="text-purple-400 animate-bounce" size={20} />
                      </div>
                    </div>
                  )}
                  ...
                  {index === lowIndex && index !== pivotIndex && (
                    <div className={getPointerStyle('left')}>
                      <div className="flex flex-col items-center">
                        <div className="text-xs font-medium mb-1 bg-red-900/50 text-red-300 rounded-md px-2 py-0.5 shadow-md">Left</div>
                        <ArrowDown className="text-red-400 animate-bounce" size={20} />
                      </div>
                    </div>
                  )}
                </div>
                ...
                <div
                  className={`${getElementSize()} flex items-center justify-center font-bold transition-all duration-300 rounded-xl ${
                    ...
                    correctlyPlacedPivotIndex.includes(index) ? 'bg-gradient-to-br from-green-500 to-green-800 text-white shadow-lg shadow-green-500/20' :
                    'bg-gradient-to-br from-gray-600 to-gray-900 text-white shadow-md'
                  }`}
                >
                  {val}
                </div>
                ...
                <div className="h-12 w-full relative">
                  ...
                  {index === highIndex && (
                    <div className={getPointerStyle('right')}>
                      <div className="flex flex-col items-center">
                        <ArrowUp className="text-blue-400 animate-bounce" size={20} />
